...
const APP_URL = import.meta.env.VITE_APP_URL ?? "https://residence-nzo.com";
const APP_NAME = import.meta.env.VITE_APP_NAME ?? "Résidence NZO";
...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: (): { meta: any[]; links: any[] } => ({
      meta: [
        ...
        // Title & Description
        { title: `${APP_NAME} · Villa moderne à Golf Park, Midvaal` },
        {
          name: "description",
          content:
            "Villa moderne à Golf Park, Midvaal : 3 chambres, 3 salles de bain, face au golf. Disponible à partir du 1er septembre 2026.",
        },
        {
          name: "keywords",
          content:
            "villa, maison à louer, Golf Park, Midvaal, Afrique du Sud, résidence, immobilier",
        },
        ...
        // Open Graph
        { property: "og:title", content: `${APP_NAME} · Villa moderne à Golf Park, Midvaal` },
        {
        ...
        { property: "og:image:alt", content: `${APP_NAME} · Villa moderne à Golf Park, Midvaal` },
        ...
        { name: "twitter:title", content: `${APP_NAME} · Villa moderne à Golf Park, Midvaal` },
        {
        ...
        { name: "twitter:image:alt", content: `${APP_NAME} · Villa moderne à Golf Park, Midvaal` },
        { name: "twitter:url", content: APP_URL },
        { name: "twitter:domain", content: "residence-nzo.com" },

        // Theme color
        { name: "theme-color", content: "#14181f" },
        { name: "msapplication-TileColor", content: "#14181f" },
        { name: "msapplication-navbutton-color", content: "#14181f" },
      ...
      links: [
        ...
        { rel: "mask-icon", href: "/safari-pinned-tab.svg", color: "#14181f" },
